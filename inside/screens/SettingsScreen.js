...
import { View,Text, TouchableOpacity,TextInput, SafeAreaView , ImageBackground,ScrollView,Alert } from 'react-native';
import {
...
>
    ...
    <TouchableOpacity 
      ...
      onPress={() => {
                   if(name!==''){
                  db.collection('Agents').doc('n6GPncsXkqd9gkEqes1E').update({
                    Name : name ,
